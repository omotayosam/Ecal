                    ...
                    <div class="col-12">
                        ...
                        <div class="top row">
                            ...
                            <div class="mt-md-5 col px-5">
                                ...
                                <div>
                                    <a href="<?php echo "preview?id=$itemID"; ?>">
                                        <span class="h5 pb-2"><?php echo $name; ?></span>
                        ...
                        <div class="down row">
                            <div class="text-center binborder pt-2 col-2">
                                <form action="#" method="POST">
                                    <button type="submit" class="mr-1 bg-white btn btn-sm" name="<?php echo "addWish_$itemID"; ?>" value="wish"><i class="far fa-heart"></i></button>
                                </form>
                            </div>
                            <div class="mt-2 col-5 col-sm-7">
                                <form action="#" method="POST">
                                    <button type="submit" class="mr-1 bg-white btn btn-sm" name="<?php echo "remCart_$itemID"; ?>" value="remove"><i class="fas fa-trash-alt"></i> <span class="trashtext">REMOVE</span></button>
                                </form>
                            </div>
                            <div class="text-right col-4 col-sm-3">
                                <form action="#" method="POST" class="mt-sm-1">
                                    <span class="d-inline-flex">
                                        ...
                                        <i class="num mt-3"><?php echo $countI; ?><hr></i>
