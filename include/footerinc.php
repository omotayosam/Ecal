...
<footer class="bg-white" style="padding-top:5px;padding-bottom:5px;"><!-- Footer -->
    ...
    <div class="mt-0 text-center">
        <b class="text-dark">&copy; NICE 2018</b>
        <br />
        <span class="text-dark">Crafted With <i id="heart" class="text-danger far fa-heart"></i> By SAMBOLT Inc.</span>        
    </div><!-- End Container-->
</footer>

<script src="wwwroot/js/faHeartHover.js"></script>