...
<?php
	...
	$title = 'E-KAL';
	if ((($currentURL) == "http://localhost/ecal/")!==false){$title = 'Home';}
	if((strpos($currentURL, "/index"))!==false){$title = 'Home';}
	if((strpos($currentURL, "/wish"))!==false){$title = 'Wish-List';}
	if((strpos($currentURL, "/search"))!==false){$title = 'Search';}
							...
							<div class="dropdown-menu dropdown-menu-right py-0">
								<?php 
									if($user == "Guest") {
										...
										<a class="dropdown-item p-3" href="recent_search"><i class="mr-3 far fa-clock"></i> Recent Searches</a><hr class="m-0 p-0" />
							...
							<div class="dropdown-menu dropdown-menu-right py-0">
								<?php
									if($user !== "Guest") {
										?>
										<a class="dropdown-item p-2" href="logout"><i class="ml-2 mr-3 fa fa-lock"></i> Sign Out</a><hr class="m-0 p-0" />
										<a class="dropdown-item p-3" href="recent_search"><i class="mr-3 fa fa-clock-o"></i> Recent Searches</a><hr class="m-0 p-0" />
										<a class="dropdown-item p-3" href="#"><i class="mr-3 fa fa-th-large"></i> Recently Viewed</a><hr class="m-0 p-0" />
										<a class="dropdown-item p-2" href="#"><i class="ml-2 mr-3 fa fa-truck"></i> My Orders</a>
										<?php
