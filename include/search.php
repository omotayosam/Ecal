            ...
            if (stristr($name, "$s_string") != false) {
                ...
                <span class='result'>
                    <a href='search?q={$name}'>
                        <div class='bg-white border-bottom'><img src='{$pic}' class='img-fluid' width='40px' /> $rep</div>
                    </a>
                </span>
            ";
            } else {
            ...
            if ((stristr($details, $s_string) != false) && (stristr($name, "$s_string") == false)) {
                ...
                <span class='result'>
                    <a href='search?q={$details}'>
                        <div class='bg-white border-bottom'><img src='{$pic}' class='img-fluid' width='40px' /> $repsd</div>
                    </a>
                </span>
            ";
            } else {
