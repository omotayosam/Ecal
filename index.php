				...
				<div class="sl-slider">
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
						<div class="sl-slide-inner">
							...
							<blockquote><p>Discover Our deal of the day.</p></blockquote>
						</div>
					</div>
					...
					<div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
						<div class="sl-slide-inner">
							...
							<h2>Shop With 100%</h2>
							<blockquote><p>confidence on KALshop.</p></blockquote>
						</div>
					</div>
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
						<div class="sl-slide-inner">
							...
							<h2>Sales & Deals</h2>
							<blockquote><p>Automobile</p></blockquote>
						</div>
					</div>
					...
					<div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
						<div class="sl-slide-inner">
							...
							<blockquote><p>Gadgets & Electronics</p></blockquote>
						</div>
					</div>
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-5" data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1">
						<div class="sl-slide-inner">
							...
							<blockquote><p>food & drinks</p></blockquote>
						</div>
					</div>
				</div><!-- /sl-slider -->
    ...
    <div class="container-fluid" style="width:83%">
        ...
        <div class="owl-carousel owl-theme">
            <div class="item">
               ...
               <div class="product-details"> <a href="#"><button class="salebutton " style="vertical-align:middle"><span>Dress | &#8358;1200 </span></button></a> </div>
            </div>
...
<div id="kashop-section-1" class="kalshop-section index-section" ><!--hot deal start-->
<section class="theme-bg text-center text-white custom-pb-18 " id="">
  <div class="timer-container">
    <div class="row">
      <div class="col-md-12">
        ...
        <a href="#"><button class="button1 shopbtn" style="vertical-align:middle"><span>Shop now </span></button>
    </a>
